...
filepath = os.path.join(os.path.abspath(os.path.dirname(os.path.realpath(__file__)))), filename)

with open(filepath, 'r') as file:
    data = file.read()

#Vulnerable line: `filepath = os.path.join(os.path.abspath(os.path.dirname(os.path.realpath(__file__)))), filename)`
